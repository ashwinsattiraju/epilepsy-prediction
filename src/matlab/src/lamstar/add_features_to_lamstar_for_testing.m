function add_features_to_lamstar_for_testing(features, lamstarManager)
    ...
    for i=1:num_of_recs
        ...
        for j=1:length(features.entropy_signal_whole(i).data);
            ...
            fprintf('Adding data to Testing set in progress ... %.4g %%\n', counter/num_of_words*100);
            ...
            % lamstarManager.addElementToFeatureSetIDForTesting(0, feature_data, c); 
            
            % entropy signal thirds
            % feature_data = [features.entropy_signal_thirds(i).data{j}];
            % lamstarManager.addElementToFeatureSetIDForTesting(1, feature_data, c); 
            
            % entropy signal fifths
            % feature_data = [features.entropy_signal_fifths(i).data{j}];
            % lamstarManager.addElementToFeatureSetIDForTesting(2, feature_data, c);
            ...
            lamstarManager.addElementToFeatureSetIDForTesting(3, feature_data, c);
            
            % kolmogorov signal thirds
            feature_data = [features.kolmogorov_signal_thirds(i).data{1}];
            lamstarManager.addElementToFeatureSetIDForTesting(4, feature_data, c);
            
            % kolmogorov signal fifths
            feature_data = [features.kolmogorov_signal_fifths(i).data{j}];
            lamstarManager.addElementToFeatureSetIDForTesting(5, feature_data, c);
            ...
            lamstarManager.addElementToFeatureSetIDForTesting(6, feature_data, c);
            
            % mean energy signal thirds
            feature_data = [features.mean_energy_signal_thirds(i).data{1}];
            lamstarManager.addElementToFeatureSetIDForTesting(7, feature_data, c);
            
            % mean energy signal fifths
            feature_data = [features.mean_energy_signal_fifths(i).data{j}];
            lamstarManager.addElementToFeatureSetIDForTesting(8, feature_data, c);
            ...
            for dec=1:8
                ...
                % lamstarManager.addElementToFeatureSetIDForTesting(9*dec+6, feature_data, c);
                ...
                % lamstarManager.addElementToFeatureSetIDForTesting(9*dec+7, feature_data, c);
                ...
                % lamstarManager.addElementToFeatureSetIDForTesting(9*dec+8, feature_data, c);
            end
            counter = counter + 1;
        end
    end
